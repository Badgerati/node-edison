...
Checkers.prototype.containsOneOf = function(value, lookupArray) {
    if (this.isEmpty(value) || this.isEmpty(lookupArray)) {
        return false;
    }
    ...
    _.some(lookupArray, (v) => {
        _found = _self.contains(value, v);
        return _found;
    });
